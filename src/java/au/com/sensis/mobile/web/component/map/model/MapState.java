...
/**
 * Encapsulates the current state of the map so that we can subsequently perform
 * operations on it, such as panning and zooming. This state does not include
 * the map image URL, which can be derived from the state.
 *
...
public class MapState {
     ...
     * Centre of the map.
     */
    private final WGS84Point coordinates;

    /**
     * Bounding box state is required if you subsequently wish to pan the map.
     */
    private final MobilesBoundingBox mapBoundingBox;
    ...
    public MapState(final WGS84Point coordinates,
            final MobilesBoundingBox mapBoundingBox, final int zoomLevel) {
