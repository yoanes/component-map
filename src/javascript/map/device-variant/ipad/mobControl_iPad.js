...
//		this.matrix =  window.getComputedStyle(this.map.layerContainerDiv).webkitTransform;
	...
	execTouchMove: function(e) {
		...
		if(this.scale == null) {
			...
			this.map.layerContainerDiv.style['-webkit-transform'] = 'translate3d(' +  -(this.dX) + 'px,' + -(this.dY) + 'px, 0)';
		}
...
//		this.map.layerContainerDiv.style['-webkit-transition-property'] = 'left, top';
//		this.map.layerContainerDiv.style['-webkit-transition-duration'] = '1s, 1s';
//		this.map.layerContainerDiv.style['-webkit-transition-timing-function'] = 'ease-out, ease-out';
//		this.map.layerContainerDiv.style['-webkit-transition-delay'] = '0 0';
		
//		this.map.layerContainerDiv.style['-webkit-transition-property'] = 'left, top';
//		this.map.layerContainerDiv.style['-webkit-transition-duration'] = '1ms, 1ms';
//		this.map.layerContainerDiv.style['-webkit-transition-timing-function'] = 'cubic-bezier(0.05, 0, 0.1, 1), cubic-bezier(0.05, 0, 0.1, 1)';
//		this.map.layerContainerDiv.style['-webkit-transition-delay'] = '0 0';
