<%@ page contentType="text/javascript" isELIgnored ="false" %>  
...
<s:url id="zoomInUrl" value="%{browseMapUrl}" includeContext="false" escapeAmp="false">
    <s:param name="act" value="%{'mzi'}" />
</s:url>

<s:url id="zoomOutUrl" value="%{browseMapUrl}" includeContext="false" escapeAmp="false">
    <s:param name="act" value="%{'mzo'}" />
</s:url>

<s:url id="panNorthUrl" value="%{browseMapUrl}" includeContext="false" escapeAmp="false">
    <s:param name="act" value="%{'mpn'}" />
</s:url>

<s:url id="panSouthUrl" value="%{browseMapUrl}" includeContext="false" escapeAmp="false">
    <s:param name="act" value="%{'mps'}" />
</s:url>

<s:url id="panWestUrl" value="%{browseMapUrl}" includeContext="false" escapeAmp="false">
    <s:param name="act" value="%{'mpw'}" />
</s:url>

<s:url id="panEastUrl" value="%{browseMapUrl}" includeContext="false" escapeAmp="false">
    <s:param name="act" value="%{'mpe'}" />
</s:url>

<s:url id="photoLayerUrl" value="%{browseMapUrl}" includeContext="false" escapeAmp="false">
    <s:param name="act" value="%{'phv'}" />
</s:url>

<s:url id="mapLayerUrl" value="%{browseMapUrl}" includeContext="false" escapeAmp="false">
    <s:param name="act" value="%{'mpv'}" />
</s:url>

<map:renderJson map="${map}" zoomInUrl="${zoomInUrl}" zoomOutUrl="${zoomOutUrl}" 
